...
draw_menu :: proc(using menu: ^Menu) {
	...
	draw_tilemap_first_pass(game.currentTilemap, game.currentOutputTileSize, viewOffset);
	draw_chests(game, viewOffset);
	draw_tilemap_second_pass(game.currentTilemap, game.currentOutputTileSize, viewOffset);
